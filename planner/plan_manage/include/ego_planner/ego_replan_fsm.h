...
namespace ego_planner
{
  ...
  private:
    ...
    /* planning data */
    bool have_trigger_, have_target_, have_odom_, have_new_target_, have_recv_pre_agent_, have_pending_target_;
    ...
    Eigen::Vector3d pending_target_;                                         // goal received before odom/state is ready
